...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_GRV,         MO(FUN), KC_LCTL, KC_LALT, KC_LGUI,       TD(TD_AIRPODS),                       TO(GAM), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT,
    ...
    _______, _______, _______, _______, _______, _______,                           TO(INS), _______, _______, _______, _______, _______,
